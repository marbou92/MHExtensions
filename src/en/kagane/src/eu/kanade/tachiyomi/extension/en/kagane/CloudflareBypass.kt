 ...
 * (the build the user reports as "soo good" at CF) — replaces the retired
 * v15 "do nothing" approach.
 *
 ...
 *    `accept`. Headers the request already carries are left untouched.
 ...
 * and re-issue the request. The token interceptor keeps handling Kagane's
 * own auth errors (401/507 without CF headers) as before.
 */
